...
public class GoodsVO {
	...
	public String toString() {
		return "GoodsVO [goodsNo=" + goodsNo + ", name=" + name + ", price=" + price + ", rapping=" + rapping
				+ ", manufacturer=" + manufacturer + ", weight=" + weight + ", description=" + description
				+ ", harvest=" + harvest + ", img1=" + img1 + ", img2=" + img2 + ", img3=" + img3 + ", img4=" + img4
				+ ", img5=" + img5 + ", category=" + category + ", type=" + type + ", seller=" + seller + "]";
	}
