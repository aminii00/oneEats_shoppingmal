...
<div class="main-container">
    ...
    <header>
        ...
        <div>
            ...
            <p class = "textsize-0  textcolor-red margin-id">10자 이상 입력</p>
            <p class =" textsize-0  textcolor-red margin-id">영문/숫자/특수문자(공백제외)만 허용하며, 2개 이상 조합</p>
            <p class =" textsize-0  textcolor-red margin-id">동일한 숫자  3개 이상 연속 사용 불가</p><br>
        </div>
        <div>
            새 비밀번호 확인 
            <br>
