...
<div class="main-container">
    ...
    <header>
        ...
        <input class ="brd-lightgray btn-round btn-midlong bg-lightgray border-0 textsize-1 margin1 margin-id " placeholder=" 인증번호를 입력하세요." type="text"></input>
        <p class = "textsize-0  textcolor-red margin_bottom">인증번호가 오지 않는다면, 통신사 수신 차단 혹은 휴대폰 번호</p>
        <p class =" textsize-0  textcolor-red margin_top">차단 여부를 확인해 주세요.</p><br>
       <br>
