...
<body>
<form method = "post" action = "${contextPath}/member/idSearch.do">
<br>
<br>
<br>
<div class="main-container">
    ...
    <header>
        ...
        <input class ="brd-lightgray btn-round margin1 btn-midlong-input textsize-1 " name = "phone" placeholder=" 휴대폰 번호를 입력해 주세요." type="text"></input>
        &nbsp
        <button class = "btn-fatfat-mina bg-lightgreen textsize-0 border-0 margin btn-round textbold">
            인증번호요청
        </button><br>
        <input class ="brd-lightgray btn-round btn-midlong bg-lightgray border-0 textsize-1 margin1 margin-id " placeholder=" 인증번호를 입력하세요." type="text"></input><br>
        <div>
