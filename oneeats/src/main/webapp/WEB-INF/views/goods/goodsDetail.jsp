            ...
            <div class="product__details__pic">
              <div class="product__details__pic__item">
                <img
                  ...
                  src="${contextPath}/download.do?imageFileName=${goods.img1}&path=goods"
                  alt=""
                />
              </div>
              <div class="product__details__pic__slider owl-carousel">
                <img
                  ...
                  src="${contextPath}/download.do?imageFileName=${goods.img2}&path=goods"
                  alt=""
                />
                <img
                  data-imgbigurl="img/product/details/product-details-3.jpg"
                  src="${contextPath}/download.do?imageFileName=${goods.img3}&path=goods"
                  alt=""
                />
                <img
                  data-imgbigurl="img/product/details/product-details-5.jpg"
                  src="${contextPath}/download.do?imageFileName=${goods.img4}&path=goods"
                  alt=""
                />
                <img
                  data-imgbigurl="img/product/details/product-details-4.jpg"
                  src="${contextPath}/download.do?imageFileName=${goods.img5}&path=goods"
                  alt=""
                />
              </div>
            </div>
