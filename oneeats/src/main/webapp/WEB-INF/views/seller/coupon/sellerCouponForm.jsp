  ...
  <body>
    ...
    <form method="post" action="#">
        ...
        <table class="textcolor-black textsize-2">
            ...
            <tr>
                ...
                <td><select name="condition" >
                    ...
                    <option value="10000원 이상 구매시">10000원 이상 구매시</option>
        ...
        <div class="div-btn">
            ...
            <button class="btn-1 btn-regular bg-lightgreen textcolor-white border-0" type="button"
            onclick='fn_openalert("쿠폰을 등록하시겠습니까?","${contextPath}/seller/coupon/sellerCouponList.do")'>쿠폰등록</button>
        </div>
    </form>
  </body>
</html>