    ...
    <form method="post" action="#">
        ...
        <table border="0" class="textcolor-black textsize-1">
            ...
            <tr>
                ...
                <td style="text-align: right;"><a href="${contextPath}/seller/hotdeal/sellerHotDealModForm.do">수정</a></td>
                <td style="text-align: right;"><a href="javascript:void(0)" onclick='fn_openalert("핫딜을 삭제하시겠습니까?","${contextPath}/seller/hotdeal/sellerHotDealList.do")'>삭제</a></td>
            </tr>
        </table>
<%-- <!--    <div> 페이징처리
