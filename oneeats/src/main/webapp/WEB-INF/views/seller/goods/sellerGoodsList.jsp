    ...
    <form method="post" action="#">
        ...
        <table border="0" class="textcolor-black textsize-1">
            ...
            <tr>
                ...
                <td>2023-08-11</td>
                <td>못난이 복숭아</td>
                <td style="text-align: right;"><a href="${contextPath}/seller/goods/sellerGoodsModForm.do">수정</a></td>
                <td style="text-align: right;"><a href="javascript:void(0)" onclick='fn_openalert("상품을 삭제하시겠습니까?","${contextPath}/seller/goods/sellerGoodsList.do")'>삭제</a></td>
            </tr>
        </table>
<%-- <!--    <div> 페이징처리
