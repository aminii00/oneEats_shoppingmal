    ...
    <form method="post" action="#">
        ...
        <table border="0" class="textcolor-black textsize-1">
            ...
            <tr>
                <td>&nbsp 1</td>
                <td>2023-08-11</td>
                <td>오늘부터 슬림하게 케일주스 2+1</td>
                <td style="text-align: right;"><a href="${contextPath}/admin/hotdeal/adminHotDealModForm.do">수정</a></td>
                <td style="text-align: right;"><a href="javascript:void(0)" onclick='fn_openalert("핫딜을 삭제하시겠습니까?","${contextPath}/admin/hotdeal/adminHotDealList.do")'>삭제</a></td>
            </tr>
        </table>
<%-- <!--    <div> 페이징처리
